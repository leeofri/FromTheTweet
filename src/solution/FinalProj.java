...
import solution.tfidf.model.WordCountsEachDocs;
...
public class FinalProj {
	...
	public static void main(String[] args) throws Exception {
		...
		String inPutPath = "/home/training/FromTheTweet/input";
...
//		result = ToolRunner.run(new Configuration(), new WordFrequence(),
//				WordContPaths);
//
//		if (result != 0) {
//			// exit with error
...
//		}
		...
		// word count each doc
//		String[] WordContEachDocPaths = { outPutPath + "/wordcountOutput",
//				outPutPath + "/wordcountEachDocOutput" };
//		 result = ToolRunner.run(new Configuration(), new WordCountsEachDocs(),
//				WordContEachDocPaths);
//
//		if (result != 0) {
//			// exit with error
//			System.exit(result);
...
//		// tfidf
//		String[] tfidfPaths = { outPutPath + "/wordcountEachDocOutput",
//				Globals.getTfidfOutputFolder().toString()};
